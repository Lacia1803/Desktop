...
namespace Lab07_2212364_PVQHien
{
	public partial class MainForm : Form
	{
		...
		private List<FoodModel> GetFoodByCategory(int? categoryId)
		{
			...
			var foods = dbContext.Foods.Include(x => x.Category).AsQueryable();
		...
		private void mnuFoods_Click(object sender, EventArgs e)
		{
			var form = new FoodManagementForm();
			form.ShowDialog();
		}

		private void mnuBills_Click(object sender, EventArgs e)
		{
		...
		private void mnuLogout_Click(object sender, EventArgs e)
		{
			...
			MessageBox.Show("Chức năng đăng xuất", "Thông báo");
		}
